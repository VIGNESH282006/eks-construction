        ...
        <div className="about-container">
          ...
          <div className="vm-flex-container">
            <div className="Our-Vision vm-box-1">
              <h2>Our Vision</h2>
              <p>
                EKS Construction has developed a comprehensive, future-ready system that addresses every challenge in the construction journey—from meticulous planning and quality assurance to timely delivery and customer satisfaction. Our approach goes beyond merely building structures; we strive to redefine modern living by fostering a culture of building.
              </p>
            </div>
            <div className="Our-Mission vm-box-2">
              <h2>Our Mission</h2>
              <p>
                EKS Construction recognizes that the construction industry faces significant challenges due to the absence of fair pricing, limited use of smart technology, and inefficient labour management systems. We are committed to bridging these gaps through innovation, transparency, and efficient project management.
              </p>
            </div>
          </div>
