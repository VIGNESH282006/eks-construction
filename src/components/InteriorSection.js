          ...
          {whyChooseUs.map((item, idx) => (
            ...
            >
              <div className="icon-wrapper">
                <img src={item.iconStatic} alt={item.alt} className="icon-static" />
                <img src={item.iconHover}  alt={item.alt} className="icon-hover" />
              </div>
              <h4>{item.title}</h4>
        ...
        <div className="philosophy-content">
          <div className="philosophy-text">
            ...
            <ul className="philosophy-points">
              <li>
                <strong>→</strong> <strong>Form Follows Function:</strong> Beautiful designs for your daily life
              </li>
              <li>
                <strong>→</strong> <strong>Sustainable Choices:</strong> Eco-friendly energy-efficient solutions
              </li>
              <li>
                <strong>→</strong> <strong>Personal Expression:</strong> Your personality reflected in every design
              </li>
              <li>
                <strong>→</strong> <strong>Timeless Appeal:</strong> Designs that remain beautiful for years to come
              </li>
            </ul>
          </div>
